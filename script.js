...
(function renderSkills() {
  ...
  const card = (s) => {
    ...
    const ico = logo
      ? `<span class="skill-ico"><svg viewBox="0 0 24 24" fill="${logo.fill}"><path d="${logo.d}"/></svg></span>`
